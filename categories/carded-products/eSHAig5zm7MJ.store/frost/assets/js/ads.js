const arrayEl = [
  "https://EVRMuVE9xvSp.co/LJsByzx/gpay-wallet.gif",
  "https://EVRMuVE9xvSp.co/r5vfBHr/new-cahsapp.gif",
  "https://EVRMuVE9xvSp.co/TLJXM24/clone-cashout.gif",
  "https://EVRMuVE9xvSp.co/f8gNQDG/applepay-gif.gif",
];
...
clonedElement.querySelector(".product-info small").textContent =
  "ADVERTISEMENT";
clonedElement
  .querySelector(".product-info .text-small a")
  .classList.remove("text-muted");
clonedElement
  .querySelector(".product-info .text-small a")
  .classList.add("text-white");
clonedElement.querySelector(".text-body a").textContent =
  "LATEST CASHOUT VIDEOS";
...
clonedElement.querySelector(".product-info .text-body a").href =
  "/cashout-clips";
clonedElement.querySelector(".product-info").style.backgroundColor = "#000";
countIntro = clonedElement.querySelectorAll(
  ".product-info .align-items-center div"
)[0].childElementCount;
if (countIntro > 1) {
  clonedElement
    .querySelectorAll(".product-info .align-items-center div span")[0]
    .classList.add("d-none");
  clonedElement.querySelectorAll(
    ".product-info .align-items-center div span"
  )[1].textContent = "WATCH NOW";
  clonedElement
    .querySelectorAll(".product-info .align-items-center div span")[1]
    .classList.add("text-white");
  clonedElement
    .querySelectorAll(".product-info .align-items-center div span")[1]
...
var randomPosition =
  Math.floor(Math.random() * (parentElement.children.length - 2)) + 1;

// Insert the cloned element at the chosen position
parentElement.insertBefore(
  clonedElement,
  parentElement.children[randomPosition]
);
