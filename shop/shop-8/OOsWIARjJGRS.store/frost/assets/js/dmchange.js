...
//                 // List of domains to check
//                 const allowedDomains = ['360logz.com','360logz.shop','OOsWIARjJGRS.store','my360logz.com'];
        ...
        socialDiv.innerHTML = `
            <div class="sicon-list">
                <a href="/social-link/telegram" class="icon-item" target="_blank">
                    <img src="https://pXmfqLMTLdg0.co/BZbp119/image.png" alt="360logz-telegram-social-link">
                </a>
                <a href="/social-link/whatsappchannel" class="icon-item" target="_blank">
                    <img src="https://pXmfqLMTLdg0.co/Y7CW5xr7/whatsappchannel.png" alt="360logz-wchannel-social-link">
                </a>
                <a href="/social-link/instagram" class="icon-item" target="_blank">
                    <img src="https://pXmfqLMTLdg0.co/kqTcgyK/image.png" alt="360logz-instagram-social-link">
                </a>
                <a href="/social-link/whatsapp" class="icon-item" target="_blank">
                    <img src="https://pXmfqLMTLdg0.co/jWR5nTY/image.png" alt="360logz-whatsapp-social-link">
                </a>
                <a href="/social-link/twitter" class="icon-item" target="_blank">
                    <img src="https://pXmfqLMTLdg0.co/LXtpBfz6/xlogo.png" alt="360logz-twitter-social-link">
                </a>
            </div>
        `;
